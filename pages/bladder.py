...
if not html_path.exists():
    html_path = Path("static") / "hummingbird_bladder.html"

if not html_path.exists():
    st.error(f"Could not locate hummingbird_bladder.html. Tried: {_ROOT / 'static' / 'hummingbird_bladder.html'}")
    st.stop()
...
render_more_popover("bladder", _sw_cols[4])
